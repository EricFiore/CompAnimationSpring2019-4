...
public class pickup1 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (piece4.gameObject.tag == "dead" && piece4.name == "p2")
        {
            counter = 3;
        }
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        if (counter == 3 && other.gameObject.CompareTag("unlock") && piece4.gameObject.tag == "dead" && piece4.name == "p2")
        {
        ...
        if (other.name == "EnemyOne" && piece5.gameObject.tag == "dead" && piece5.name == "p2")
        {
        ...
        if (other.name == "EnemyOne" && piece6.gameObject.tag == "dead" && piece6.name == "p2")
        {
