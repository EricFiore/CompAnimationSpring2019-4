...
public class GroupTwoPlayThree : MonoBehaviour
{
    public UnityEngine.AI.NavMeshAgent navMeshAgent;
    public Transform roomTwoGoal;
    public DirectorRoomTwo _directorRoomTwo;
    ...
    void Start()
    {
        ...
        navMeshAgent.destination = roomTwoGoal.position;
    ...
    public void resume()
    {
        if (Vector3.Distance(roomTwoGoal.position, transform.position) < 4.0f)
        {
